...
class _ToggleButtonState extends State<ToggleButton> {
  ...
  Widget build(BuildContext context) {
    _leftDescriptionColor = isLeftActive ? widget.activeTextColor : widget.inactiveTextColor;
    _rightDescriptionColor = !isLeftActive ? widget.activeTextColor : widget.inactiveTextColor;
    double toggleAxis = isLeftActive ? widget._rightToggleAlign : widget._leftToggleAlign;
    return Container(
      width: widget.width,
        ...
        children: [
          ...
          GestureDetector(
            onTap: () {
              ...
              isLeftActive ? widget.onLeftToggleActive() : widget.onRightToggleActive();
            },
            child: Align(
              ...
              child: Container(
                ...
                child: Text(
                  ...
                  style: kwhiteTextStyle.copyWith(color: _leftDescriptionColor, fontWeight: FontWeight.bold),
                ),
              ),
            ),
          ),
            ...
            child: Align(
              ...
              child: Container(
                ...
                child: Text(
                  ...
                  style: kwhiteTextStyle.copyWith(color: _rightDescriptionColor, fontWeight: FontWeight.bold),
                ),
              ),
            ),
          ),
